...
export const RESOURCES = [
  ...
  { name: 'course-categories', label: 'Course fields', model: CourseCategory, schema: V.courseCategorySchema, searchable: ['label', 'key'] },
  { name: 'study-levels', label: 'Study levels', model: StudyLevel, schema: V.studyLevelSchema, searchable: ['title', 'description'] },
  {
  ...
  { name: 'testimonials', label: 'Testimonials', model: Testimonial, schema: V.testimonialSchema, searchable: ['name', 'quote', 'program'] },
  { name: 'team', label: 'Team', model: TeamMember, schema: V.teamMemberSchema, searchable: ['name', 'role', 'bio'] },
  { name: 'milestones', label: 'Milestones', model: Milestone, schema: V.milestoneSchema, searchable: ['year', 'title', 'description'] },
  { name: 'values', label: 'Values', model: Value, schema: V.valueSchema, searchable: ['title', 'description'] },
  { name: 'stats', label: 'Stats', model: Stat, schema: V.statSchema, searchable: ['label'] },
  { name: 'process-steps', label: 'Process steps', model: ProcessStep, schema: V.processStepSchema, searchable: ['title', 'description'] },
  { name: 'faqs', label: 'FAQs', model: Faq, schema: V.faqSchema, searchable: ['question', 'answer'] },
  { name: 'comparison-rows', label: 'Comparison table', model: ComparisonRow, schema: V.comparisonRowSchema, searchable: ['country', 'best'] },
  {
  ...
  { name: 'clients', label: 'Clients & partners', model: Client, schema: V.clientSchema, searchable: ['name', 'country'] },
  { name: 'post-categories', label: 'Blog categories', model: PostCategory, schema: V.postCategorySchema, searchable: ['label', 'key'] },
  {
    name: 'video-testimonials', label: 'Video testimonials',
